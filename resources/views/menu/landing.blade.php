...
@section('title','Donor Merah Yogyakarta')
@section('content')
        ...
        <section class="hero hero-style-2">
            ...
            <div class="hero-shape">
                <img src="assets/images/slider/shape.svg" alt="">
            </div>
        </section>
        <!-- end of hero slider -->
                ...
                <div class="row">
                    <div class="col-lg-6 col-md-6 colsm-12">
                        <div class="wpo-about-text">
                            ...
                            <div class="btns">
                                <a href="#" class="theme-btn" tabindex="0">Donate Now</a>
                                <ul>
                                    <li class="video-holder">
                    ...
                    <div class="col-lg-12">
                        <div class="wpo-cta-text">
                            ...
                            <div class="btns">
                                ...
                                <a href="#" class="theme-btn-s2">Join Us Now</a>
                            </div>
                        </div>
                    </div>
                </div>
